...
MY_NUMBER = os.getenv("MY_NUMBER", "your-number")
...
async def resume() -> str:
    ...
    """
    try:
        # Read the resume from the markdown file
        resume_path = Path(RESUME_FILE)
        if not resume_path.exists():
            return "# Resume Not Found\n\nResume file not found. Please ensure resume.md exists in the project directory."
        ...
        return f"# Error Reading Resume\n\nAn error occurred while reading the resume: {str(e)}"
